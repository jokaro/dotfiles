...
-- Set up Java path for JDTLS (make this dynamic)
local java_home = os.getenv 'JAVA_HOME' or '/opt/homebrew/opt/openjdk@21'
...
local config = {
  ...
  cmd = {
    ...
    -- Additional bundles to fix JaCoCo errors
    '-Dasm.version=9.7.0',
  ...
  root_dir = require('jdtls.setup').find_root { '.git', 'mvnw', 'pom.xml', 'build.gradle', 'gradlew', '.gradlew' },
    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
          ...
          {
            name = 'JavaSE-19',
            path = '/opt/homebrew/opt/openjdk@19',
          },
          {
            name = 'JavaSE-20',
